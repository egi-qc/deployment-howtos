...
## Deployment with `puppet apply`
    ...
    $ git clone https://github.com/egi-qc/deployment-howtos && cd deployment-howtos/frontier-squid/centos7
    ...
    $ puppet apply --modulepath /etc/puppet/modules manifests/frontier_squid.pp
...
Jenkins build URL: https://jenkins.egi.ifca.es/job/frontier-squid/43
