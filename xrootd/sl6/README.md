...
## Deployment with `puppet apply`
    ...
    $ git clone https://github.com/egi-qc/deployment-howtos && cd deployment-howtos/xrootd/sl6
...
Product version:
Jenkins build URL: https://jenkins.egi.ifca.es/job/QualityCriteriaValidation/xrootd/33
