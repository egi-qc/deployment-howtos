...
## Deployment with `puppet apply`
    ...
    $ git clone https://github.com/egi-qc/deployment-howtos && cd deployment-howtos/fts/centos7
    ...
    $ puppet apply --modulepath /etc/puppet/modules manifests/fts.pp
...
Jenkins build URL: https://jenkins.egi.ifca.es/job/fts/46
